...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
  ...
  if phone_talk == 0 and len(talk_frames) != 0:
    cv2.putText(frame,"Last Call: About "+ str(len(talk_frames[-1])/2)+" seconds",(140,30),cv2.FONT_HERSHEY_SIMPLEX,0.5, (0, 0, 255), 2,cv2.LINE_AA)

  cv2.putText(frame,text_display,(140,60),cv2.FONT_HERSHEY_SIMPLEX,0.5, (0, 0, 255), 2,cv2.LINE_AA)
